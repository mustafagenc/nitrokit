#!/bin/bash
# filepath: scripts/generate_release_notes.sh
...
echo "git checkout $TAG"
echo "./scripts/dependency_updater.sh --dry-run  # Preview updates"
echo "./scripts/dependency_updater.sh            # Apply updates"
...
echo "- 🛠️ **Shell Scripts Guide**: [scripts/README.md](https://github.com/mustafagenc/nitrokit/blob/main/scripts/README.md)"
...
echo "- 🌍 **Live Demo**: [https://nitrokit.tr](https://nitrokit.tr)"
echo ""
echo "### 🆘 Getting Help"
echo ""
echo "If you encounter any issues with this release:"
echo ""
echo "1. Check the [troubleshooting guide](https://github.com/mustafagenc/nitrokit/blob/main/scripts/README.md#-troubleshooting-guide)"
echo "2. Search [existing issues](https://github.com/mustafagenc/nitrokit/issues)"
echo "3. Use the automation scripts: \`./scripts/dependency_updater.sh --restore BACKUP_ID\`"
