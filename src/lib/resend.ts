...
async function saveContact(data: TNewsletterFormSchema): Promise<CreateContactResponse> {
    const { email } = data;
...
async function sendEmail(data: TContactFormSchema): Promise<TSendEmailResponse> {
