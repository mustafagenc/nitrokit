...
const logos = [
    {
        darkSrc: 'https://nitrokit.tr/images/brands/nextjs-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/nextjs-black.svg',
        alt: 'Next.js',
        width: 150,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/typescript.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/typescript.svg',
        alt: 'Typescript',
        width: 36,
        height: 36,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/tailwindcss.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/tailwindcss.svg',
        alt: 'Tailwind CSS',
        width: 50,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/prisma-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/prisma-black.svg',
        alt: 'Prisma',
        width: 100,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/radix-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/radix-black.svg',
        alt: 'Radix-UI',
        width: 95,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/next-intl-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/next-intl-black.svg',
        alt: 'Next-Intl',
        width: 130,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/react-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/react-black.svg',
        alt: 'React',
        width: 33,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/authjs.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/authjs.svg',
        alt: 'Auth.js',
        width: 27,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/resend-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/resend-black.svg',
        alt: 'Resend',
        width: 30,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/lucide-white.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/lucide-black.svg',
        alt: 'Lucide-react',
        width: 30,
        height: 30,
    ...
    {
        darkSrc: 'https://nitrokit.tr/images/brands/zod.svg',
        lightSrc: 'https://nitrokit.tr/images/brands/zod.svg',
        alt: 'Zod',
        width: 30,
        height: 30,
        href: 'https://zod.dev/',
