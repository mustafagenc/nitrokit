...
export function AuthjsIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            width="210"
            height="232"
        ...
        >
            ...
            <path
                ...
                fill={props.color || 'url(#authjs-gradient-1)'}
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                ...
                fill={props.color || 'url(#authjs-gradient-2)'}
            />
            <path
                ...
                fill={props.color || 'url(#authjs-gradient-3)'}
                fillOpacity="0.21"
            />
            ...
            <path
                ...
                fill={props.color || 'url(#authjs-gradient-4)'}
            />
        </svg>
    );
}
